...
/**
 * _read - read the file and print out error message if failled
...
/**
 * elf_version - prints the ELF version
 * @buffer: the ELF header
 */
...
/**
 * elf_osabi - prints the ELF OS/ABI
 * @buffer: the ELF header
 */
 ...
 * @buffer: string of the entry point address
...
/**
 * main - copies the file's contents to another file
