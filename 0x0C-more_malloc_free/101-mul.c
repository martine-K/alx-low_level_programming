...
/**
 * get_digit - it converts a digit character to a corresponding int.
...
/**
 * main - the main multiplies two positive numbers.
 * @argv: number of arguments passed to the program.
 * @argc: Array of pointers to the arguments.
 *
 * Description: If the num of args is incorrect or one num
