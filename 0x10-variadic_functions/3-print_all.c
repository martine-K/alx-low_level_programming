...
/**
 * op_c - it print character .
 * @form: the name va_list
 *
 * Return: Nothing.
 */
...
/**
 * op_f - prints out FLoat numbers
 * @form: the name of va_list
 *
 * Return: Null
 */
...
/**
 * print_all - checks the code
 * @format: the number of arguments in character format
 *
 * Return: Nothing.
 */
